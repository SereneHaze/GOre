...
var file_implant_proto_rawDesc = []byte{
	...
	,
	...
	0x6e, 0x64, 0x42, 0x0e, 0x5a, 0x0c, 0x67, 0x6f, 0x72, 0x65, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x61,
...
var file_implant_proto_depIdxs = []int32{
	1, // 0: grpcapi.Implant.SendCommand:input_type -> grpcapi.Registration
	...
	0, // 4: grpcapi.Implant.SendCommand:output_type -> grpcapi.Command
...
type ImplantClient interface {
	SendCommand(ctx context.Context, in *Registration, opts ...grpc.CallOption) (*Command, error)
...
func (c *implantClient) SendCommand(ctx context.Context, in *Registration, opts ...grpc.CallOption) (*Command, error) {
	out := new(Command)
	err := c.cc.Invoke(ctx, "/grpcapi.Implant/SendCommand", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ImplantServer interface {
	SendCommand(context.Context, *Registration) (*Command, error)
...
func (*UnimplementedImplantServer) SendCommand(context.Context, *Registration) (*Command, error) {
...
func _Implant_SendCommand_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Registration)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ImplantServer).SendCommand(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpcapi.Implant/SendCommand",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ImplantServer).SendCommand(ctx, req.(*Registration))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Implant_SendCommand_Handler,
		},
		{
